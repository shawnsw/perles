...
func TestEmbeddedMode_New(t *testing.T) {
	m := New()
...
func TestEmbeddedMode_Init(t *testing.T) {
	m := New()
...
func TestEmbeddedMode_SetSize(t *testing.T) {
	m := New()
...
func TestEmbeddedMode_WindowSizeMsg(t *testing.T) {
	m := New()
...
func TestEmbeddedMode_QuitKeys(t *testing.T) {
	tests := []struct {
		name string
		key  tea.KeyMsg
	}{
...
func TestEmbeddedMode_OtherKeyMsg(t *testing.T) {
	m := New().SetSize(80, 24)
...
func TestEmbeddedMode_EmptyDimensions(t *testing.T) {
	tests := []struct {
		name   string
		width  int
		height int
...
func TestEmbeddedMode_View_ContainsTitle(t *testing.T) {
	m := New().SetSize(80, 24)
	view := m.View()
...
func TestEmbeddedMode_View_ContainsEmbeddedText(t *testing.T) {
	m := New().SetSize(80, 24)
	view := m.View()

	require.Contains(t, view, "embedded dolt mode", "expected view to contain embedded mode text")
}

func TestEmbeddedMode_View_ContainsServerModeInstruction(t *testing.T) {
	m := New().SetSize(80, 24)
	view := m.View()

	require.Contains(t, view, "bd init --server", "expected view to contain server mode instruction")
}

func TestEmbeddedMode_View_ContainsHint(t *testing.T) {
	m := New().SetSize(80, 24)
	view := m.View()
...
func TestEmbeddedMode_View_ContainsChainArt(t *testing.T) {
...
func TestEmbeddedMode_View_Stability(t *testing.T) {
	m := New().SetSize(80, 24)
	view1 := m.View()
	view2 := m.View()
...
func TestEmbeddedMode_View_VariousSizes(t *testing.T) {
	tests := []struct {
		name   string
		width  int
		height int
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			require.Contains(t, view, "embedded dolt mode", "expected embedded mode text")
			require.Contains(t, view, "Press q to quit", "expected quit hint")
		})
	}
}

// TestEmbeddedMode_View_Golden_Standard uses teatest golden file comparison for 80x24.
// Run with -update flag to update golden files: go test -update ./internal/ui/embeddedmode/...
func TestEmbeddedMode_View_Golden_Standard(t *testing.T) {
	m := New().SetSize(80, 24)
	view := m.View()
...
// TestEmbeddedMode_View_Golden_Large uses teatest golden file comparison for 120x40.
func TestEmbeddedMode_View_Golden_Large(t *testing.T) {
	m := New().SetSize(120, 40)
	view := m.View()
